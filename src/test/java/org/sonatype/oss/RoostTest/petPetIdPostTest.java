...
public class petPetIdPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/sonatype/oss/RoostTest/pet_petIdPostTest.csv", envVarsList);
    }
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.header("name", testData.get("name") != null ? testData.get("name") : "")
				.header("status", testData.get("status") != null ? testData.get("status") : "")
