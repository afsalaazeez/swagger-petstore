...
public class userLogoutGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/sonatype/oss/RoostTest/user_logoutGetTest.csv", envVarsList);
    }

  
    @Test  
    public void userLogoutGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.println("Request: GET /user/logout");
