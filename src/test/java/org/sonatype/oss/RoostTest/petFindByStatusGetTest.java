...
public class petFindByStatusGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/sonatype/oss/RoostTest/pet_findByStatusGetTest.csv", envVarsList);
    }
    ...
    public void petFindByStatusGet_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("URL1_BASE_URL") != null && !testData.get("URL1_BASE_URL").isEmpty()) ? testData.get("URL1_BASE_URL"): "https://petstore.swagger.io/v2";  
