...
public class userLoginGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/sonatype/oss/RoostTest/user_loginGetTest.csv", envVarsList);
    }
...
if(stringifiedStatusCode.equals("400")){					System.out.println("Description: Invalid username/password supplied");
				}
