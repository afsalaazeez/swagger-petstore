...
public class storeOrderPostTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/sonatype/oss/RoostTest/store_orderPostTest.csv", envVarsList);
    }

  
    @Test  
    public void storeOrderPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.println("Request: POST /store/order");
...
if(stringifiedStatusCode.equals("400")){					System.out.println("Description: Invalid Order");
				}
