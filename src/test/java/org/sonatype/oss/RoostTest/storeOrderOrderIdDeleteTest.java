...
public class storeOrderOrderIdDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/sonatype/oss/RoostTest/store_order_orderIdDeleteTest.csv", envVarsList);
    }

  
    @Test  
    public void storeOrderOrderIdDelete_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.println("Request: DELETE /store/order/{orderId}");
...
if(stringifiedStatusCode.equals("404")){					System.out.println("Description: Order not found");
				}
