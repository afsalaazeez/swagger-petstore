...
public class petFindByTagsGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/sonatype/oss/RoostTest/pet_findByTagsGetTest.csv", envVarsList);
    }
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.queryParam("tags", testData.get("tags") != null ? testData.get("tags") : "")
                .when()
                .get("/pet/findByTags")  
                .then() 
                .extract().response(); 
