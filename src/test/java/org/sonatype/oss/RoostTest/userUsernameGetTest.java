...
public class userUsernameGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/sonatype/oss/RoostTest/user_usernameGetTest.csv", envVarsList);
    }

  
    @Test  
    public void userUsernameGet_Test() throws JSONException {
        this.setUp();
...
if(stringifiedStatusCode.equals("400")){					System.out.println("Description: Invalid username supplied");
				}
